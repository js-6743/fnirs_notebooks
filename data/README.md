...
~0.6 GB) — download it from NITRC and extract it into this folder.
...
Only `resting_state_1/` is required. If your unzipped folder has a different
name, rename it to `resting_state_1`.
